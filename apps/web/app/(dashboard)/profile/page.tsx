                ...
                <Grid size={{ xs: 12, md: 8 }}>
                    ...
                    <Grid container spacing={3} sx={{ mb: 4 }}>
                        ...
                        <Grid size={{ xs: 6, sm: 3 }}>
                            <Card>
                                <CardContent>
                                    <LocalFireDepartment sx={{ fontSize: 32, color: '#ff6b35', mb: 1 }} />
                                    <Typography variant="h4" fontWeight={700}>
                                        {stats.currentStreak}
                                    </Typography>
                                    <Typography variant="caption" color="text.secondary">
                        ...
                        <Grid size={{ xs: 6, sm: 3 }}>
                            <Card>
                                <CardContent>
                                    <CalendarMonth sx={{ fontSize: 32, color: 'secondary.main', mb: 1 }} />
                                    <Typography variant="h4" fontWeight={700}>
                                ...
                                {recentActivity.map((activity, index) => (
                                    <Stack
                                        ...
                                        sx={{
                                            p: 1.5,
                                            borderRadius: 1,
                                            bgcolor: activity.streak ? 'rgba(255, 107, 53, 0.05)' : 'transparent',
                                        }}
                                    >
