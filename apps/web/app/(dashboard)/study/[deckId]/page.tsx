...
import { Close, VolumeUp, Lightbulb } from "@mui/icons-material";
...
export default function StudySessionPage({ params }: StudySessionPageProps) {
  ...
  const handlePronunciation = () => {
    ...
    if ("speechSynthesis" in globalThis) {
      ...
      // Set language based on deck (Spanish in this case)
      // You can make this dynamic based on deck.language later
