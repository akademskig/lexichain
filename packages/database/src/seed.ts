...
async function main() {
              ...
              create: [
                {
                  ...
                  cards: {
                    create: [
                      ...
                      {
                        type: "quiz",
                        front: "Which greeting would you use in the morning?",
                        back: "Buenos días",
                        quizOptions: [
              ...
              create: [
                {
                  ...
                  cards: {
                    create: [
                      ...
                      {
                        type: "quiz",
                        front: "How do you say 'Five' in Spanish?",
                        back: "Cinco",
                        quizOptions: [
  ...
  // Create course progress for the user (Spanish - enrolled)
  ...
  // Enroll user in French course (just started, no progress)
  await prisma.courseProgress.create({
    data: {
      userId: user.id,
  ...
  console.log("✅ Created course progress and enrollments");
